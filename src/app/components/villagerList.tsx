              ...
              >
                <ul className="flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium rtl:space-x-reverse dark:border-gray-700 dark:bg-gray-400 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:p-0 md:dark:bg-gray-500">
                  <li>
                    <a
                      href="#"
                      className="block rounded px-3 py-2 text-white dark:text-white md:bg-transparent md:p-0 md:text-blue-730 md:dark:text-yellow-300 md:dark:hover:text-yellow-300"
                      aria-current="page"
                    >
                      Villagers
                    </a>
                  ...
                  <li>
                    <a
                      href="#"
                      className="block rounded px-3 py-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-yellow-300"
                    >
                      Items
                    </a>
                  </li>
